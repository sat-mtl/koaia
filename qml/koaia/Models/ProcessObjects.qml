...
QtObject {
    ...
    property QtObject streamDiffusion: QtObject {
        ...
        property var resolution:        Score.inlet(process_object, 9)
        property var guidance_type:     Score.inlet(process_object, 10)
        property var add_noise:         Score.inlet(process_object, 11)
        ...
        property var feed_prev_input:   Score.inlet(process_object, 15)
        property var feed_prev_output:  Score.inlet(process_object, 16)
        property var controlNet_scale:  Score.inlet(process_object, 17)
        property var iP_Adapter_scale:  Score.inlet(process_object, 18)
        property var loRA_scale:        Score.inlet(process_object, 19)
        property var klein_quality:     Score.inlet(process_object, 20)
        property var interpolation_exp: Score.inlet(process_object, 21)
        property var async:             Score.inlet(process_object, 22)
        property var async_pacing:      Score.inlet(process_object, 23)
        property var control_style:     Score.inlet(process_object, 24)
        property var embedding:         Score.inlet(process_object, 25)
