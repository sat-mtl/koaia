...
QtObject {
    ...
    property QtObject streamDiffusion: QtObject {
        ...
        property var trigger:            Score.inlet(process_object, "Trigger")
        property var workflow:           Score.inlet(process_object, "Workflow")
        property var prompt_plus:        Score.inlet(process_object, "Prompt +")
        property var prompt_minus:       Score.inlet(process_object, "Prompt -")
        property var engines:            Score.inlet(process_object, "Engines")
        property var seed:               Score.inlet(process_object, "Seed")
        property var guidance:           Score.inlet(process_object, "Guidance")
        property var timesteps:          Score.inlet(process_object, "Timesteps")
        property var resolution:         Score.inlet(process_object, "Resolution")
        property var guidance_type:      Score.inlet(process_object, "Guidance type")
        property var add_noise:          Score.inlet(process_object, "Add noise")
        property var denoising_batch:    Score.inlet(process_object, "Denoising batch")
        property var manual_mode:        Score.inlet(process_object, "Manual mode")
        property var delta:              Score.inlet(process_object, "Delta")
        property var feed_prev_input:    Score.inlet(process_object, "Feed prev. input")
        property var feed_prev_output:   Score.inlet(process_object, "Feed prev. output")
        property var controlNet_scale:   Score.inlet(process_object, "ControlNet scale")
        property var iP_Adapter_scale:   Score.inlet(process_object, "IP-Adapter scale")
        property var loRA_scale:         Score.inlet(process_object, "LoRA scale")
        property var klein_quality:      Score.inlet(process_object, "Klein quality")
        property var interpolation_exp:  Score.inlet(process_object, "Interpolation exp")
        property var async:              Score.inlet(process_object, "Async")
        property var async_pacing:       Score.inlet(process_object, "Async pacing")
        property var out:                Score.outlet(process_object, "Out")
    }
