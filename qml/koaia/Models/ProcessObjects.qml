...
QtObject {
    ...
    property QtObject streamDiffusion: QtObject {
        ...
        property var control_style:     Score.inlet(process_object, 1)
        property var embedding:         Score.inlet(process_object, 2)
        property var trigger:           Score.inlet(process_object, 3)
        property var workflow:          Score.inlet(process_object, 4)
        property var prompt_plus:       Score.inlet(process_object, 5)
        property var prompt_minus:      Score.inlet(process_object, 6)
        property var engines:           Score.inlet(process_object, 7)
        property var seed:              Score.inlet(process_object, 8)
        property var guidance:          Score.inlet(process_object, 9)
        property var timesteps:         Score.inlet(process_object, 10)
        property var resolution:        Score.inlet(process_object, 11)
        property var guidance_type:     Score.inlet(process_object, 12)
        property var add_noise:         Score.inlet(process_object, 13)
        property var denoising_batch:   Score.inlet(process_object, 14)
        property var manual_mode:       Score.inlet(process_object, 15)
        property var delta:             Score.inlet(process_object, 16)
        property var feed_prev_input:   Score.inlet(process_object, 17)
        property var feed_prev_output:  Score.inlet(process_object, 18)
        property var controlNet_scale:  Score.inlet(process_object, 19)
        property var iP_Adapter_scale:  Score.inlet(process_object, 20)
        property var loRA_scale:        Score.inlet(process_object, 21)
        property var klein_quality:     Score.inlet(process_object, 22)
        property var interpolation_exp: Score.inlet(process_object, 23)
        property var async:             Score.inlet(process_object, 24)
        property var async_pacing:      Score.inlet(process_object, 25)
